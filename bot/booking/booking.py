...
class Booking(webdriver.Chrome):
    ...
    def select_adults(self,count=1):
        ...
        while True:
            subtract_button = self.find_element_by_css_selector('button[data-bui-ref="input-stepper-subtract-button"]')
        ...
        increase_button = self.find_element_by_css_selector('button[data-bui-ref="input-stepper-add-button"]')
